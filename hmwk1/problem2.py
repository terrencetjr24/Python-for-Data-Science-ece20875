...
# A client has come to you asking how to perform version control operations with git on their file 'git_commands.py'
# so that they can work on and submit files to receive credit for a class. To help them, you will fill in variable values so that print statements print out correct output to show them what commands they need to enter.
